...
On Chain Trade Guild for Artisans addresses this by turning the workflow into a Stellar testnet record with clear state transitions. Everyday payment workflows need wallet-native settlement, verifiable records, and simple testnet onboarding.
...
Track 5 Commerce, Markets, and DeFi
...
```bash
stellar contract deploy --wasm target/wasm32v1-none/release/on_chain_trade_guild_for_artisans_contract.wasm --source alice --network testnet -- --admin alice --asset CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC --project_name "On Chain Trade Guild for Artisans"
```
...
This project is generated as an original StellarX Philippines full-stack starter from idea #48. It uses Stellar testnet, Soroban, Freighter, and current ecosystem SDKs as an extensible hackathon baseline rather than a barely modified template.
